...
<template>
  <div class="placeholder-page">
    ...
    <div class="page-body">
      <h2 class="page-title">付费策略与订阅</h2>
      <p class="page-desc">定价方案配置、会员套餐管理及订阅数据统计。</p>
...
.page-desc { font-size: 0.9rem; color: #64748b; margin: 0 0 32px; }
.coming-soon {
  background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px;
  padding: 80px 40px; text-align: center; color: #94a3b8; font-size: 1rem;
}
</style>
