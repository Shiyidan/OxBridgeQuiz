      ...
      series: [
        {
          ...
          symbol: 'circle',
          symbolSize: 5,
          lineStyle: { width: 3, color: '#2f8063' },
          itemStyle: { color: '#2f8063', borderColor: '#ffffff', borderWidth: 1 },
          areaStyle: {
            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              { offset: 0, color: 'rgba(47, 128, 99, 0.30)' },
              { offset: 0.58, color: 'rgba(143, 190, 169, 0.18)' },
              { offset: 1, color: 'rgba(220, 238, 228, 0.08)' },
            ]),
          },
          markLine:
            score === null
              ...
              : {
                  symbol: ['none', 'none'],
                  silent: true,
                  lineStyle: { color: '#1d5b47', width: 1.5, type: 'dashed' },
                  label: {
                    show: true,
                    position: 'end',
                    rotate: 0,
                    ...
                    color: '#ffffff',
                    backgroundColor: 'rgba(29, 91, 71, 0.92)',
                    borderRadius: 5,
                    padding: [6, 9],
                    fontWeight: 700,
                  },
          ...
          : [
              {
                ...
                symbolSize: 13,
                z: 5,
                itemStyle: { color: '#1d5b47', borderColor: '#ffffff', borderWidth: 3 },
                tooltip: { show: false },
              },
            ]),
      ],
